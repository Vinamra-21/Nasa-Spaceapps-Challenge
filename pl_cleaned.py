...
all_combinations_data_cleaned = all_combinations_data.dropna()

# Save the cleaned data to a CSV file
all_combinations_data_cleaned.to_csv('all_country_experiment_data_cleaned.csv', index=False)

print("Data with no missing values saved to 'all_country_experiment_data_cleaned.csv'")
